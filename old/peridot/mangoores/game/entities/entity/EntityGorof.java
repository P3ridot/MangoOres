package peridot.mangoores.game.entities.entity;
...
public class EntityGorof extends CreatureEntity {
    @SuppressWarnings("unchecked")
    public EntityGorof(EntityType<? extends CreatureEntity> type, World worldIn) {
