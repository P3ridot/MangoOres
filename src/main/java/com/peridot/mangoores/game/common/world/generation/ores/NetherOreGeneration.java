...
public class NetherOreGeneration {
    ...
    public NetherOreGeneration(Block block, int count, int bottomOffset, int topOffset, int maximum, int size) {
        this.block = block;
        this.count = count;
    ...
    public void generateOre() {
        for (Biome biome : ForgeRegistries.BIOMES) {
            ...
            biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES,
                    Feature.ORE
                            .withConfiguration(
                                    new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NETHERRACK, block.getDefaultState(), size))
